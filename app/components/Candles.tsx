...
const CSS = `
  .twh-candles {
    ...
    gap:clamp(12px,3vw,32px);padding:0 2rem;
  }
  ...
  @media(prefers-reduced-motion:reduce){
    .twh-fo,.twh-fm,.twh-fc,.twh-fg{animation:none!important;}
  }
`
        ...
        return (
          <div key={i} className="twh-candle">
            ...
            <div
              ...
              style={{ width: c.w + 4, height: flameH }}
            >
              <div
                className="twh-fg"
                style={{ width: glowW, animation: `${c.fg} ease-in-out infinite`, animationDelay: delay }}
              />
              <div
                className="twh-fo"
                style={{ width: c.w + 2, height: Math.round(flameH * 0.8), animation: `${c.fo} ease-in-out infinite`, animationDelay: delay }}
              />
              <div
                className="twh-fm"
                style={{ width: Math.round(c.w * 0.7), height: Math.round(flameH * 0.6), animation: `${c.fm} ease-in-out infinite`, animationDelay: delay }}
              />
              <div
                className="twh-fc"
                style={{ width: Math.round(c.w * 0.28), height: Math.round(flameH * 0.35), animation: `${c.fc} ease-in-out infinite`, animationDelay: delay }}
              />
            </div>
            ...
            >
              <div className="twh-drip" style={{ left: c.dripL.l, top: c.dripL.t, width: c.dripL.w, height: c.dripL.h }} />
              <div className="twh-drip" style={{ left: c.dripR.l, top: c.dripR.t, width: c.dripR.w, height: c.dripR.h }} />
            </div>

            {/* Holder & base */}
            <div className="twh-holder" style={{ width: c.w + 8 }} />
            <div className="twh-base"   style={{ width: c.w + 16 }} />
