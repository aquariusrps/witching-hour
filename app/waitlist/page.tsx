...
export const metadata: Metadata = {
  title: 'The Witching Hour — Coming Soon',
  description:
    'The circle opens soon. Join the waitlist for The Witching Hour — a fan community for Charmed, Buffy the Vampire Slayer, Angel, and the magic that never left.',
  openGraph: {
    title: 'The Witching Hour — Coming Soon',
    description:
      'The circle opens soon. Join the waitlist for The Witching Hour — a fan community for Charmed, Buffy the Vampire Slayer, Angel, and the magic that never left.',
