...
export default function MojoPersonalImageUpload({
  folderId = null,
  initialTags = '',
  onUploadComplete,
}: {
  ...
  const processItem = useCallback(
    async (item: QueueItem) => {
      ...
      const storagePath = 'personal/' + crypto.randomUUID() + '.' + ext
      ...
      const result = await registerUploadedPersonalImage({
                ...
                <div key={item.id} style={{ background: 'var(--claret)', border: '1px solid var(--elevated)', borderRadius: 2, padding: '8px 12px', marginBottom: 6 }}>
                  ...
                  <div style={{ marginTop: 6 }}>
                    ...
                    <input
                      ...
                      placeholder="eg. reference, photoshoot, icons"
