...
const COLOR_PALETTE: { label: string; value: string | null }[] = [
  ...
  { label: 'Rose Ash', value: '#f0d4c0' },
  { label: 'Mist', value: '#b89080' },
  { label: 'Gold', value: '#e0b028' },
  { label: 'Ember', value: '#c83818' },
  { label: 'Moonstone', value: '#3878a8' },
  { label: 'Moon Light', value: '#58a8d0' },
  { label: 'Gold Light', value: '#f0c840' },
  { label: 'Faded', value: '#6a4838' },
